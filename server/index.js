    ...
    return __generator(this, function (_g) {
        switch (_g.label) {
            case 0:
                ...
                defaultSystemPrompt = "你是一个专业的数据库表结构贯标检测助手。帮助用户检查数据库表结构是否符合企业级贯标规范，包括命名规范、字段类型、索引设计、安全合规等方面。请用专业但易懂的方式分析问题，并给出具体的改进建议。";
            ...
            case 2:
                ...
                _loop_1 = function () {
                    ...
                    if (msg.type === "system" && msg.subtype === "init") {
                        ...
                        var resultMsg = msg;
                        res.write("data: ".concat(JSON.stringify({ type: "done", duration: resultMsg.duration_ms, cost: resultMsg.total_cost_usd }), "\n\n"));
                    }
                };

  ...
  <div class="w-[1440px] h-[810px] shadow-2xl relative overflow-hidden slide-bg">
    <div class="w-[1350px] h-[720px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 relative">
      <svg class="absolute inset-0 w-full h-full opacity-[0.06]" xmlns="http://www.w3.org/2000/svg">
        <defs><pattern id="hex9" x="0" y="0" width="60" height="52" patternUnits="userSpaceOnUse"><polygon points="30,2 56,15 56,37 30,50 4,37 4,15" fill="none" stroke="#5eead4" stroke-width="0.8"/></pattern></defs>
        <rect width="100%" height="100%" fill="url(#hex9)"/>
      </svg>
        ...
        <div class="text-center">
          <div class="relative inline-block mb-8">
            <div class="w-28 h-28 rounded-full border-2 border-teal-400/60 flex items-center justify-center mx-auto" style="box-shadow:0 0 40px rgba(13,148,136,0.15),inset 0 0 30px rgba(13,148,136,0.08);">
              <span class="text-5xl font-mono font-bold text-teal-400" style="text-shadow:0 0 12px rgba(13,148,136,0.6);">03</span>
            </div>
          ...
          <h1 class="text-5xl font-bold text-white mb-4 tracking-wide">检测体系</h1>
          ...
          <p class="text-lg text-teal-400/80 font-light tracking-widest">五大贯标检测维度</p>
        </div>
      </div>
    </div>
  </div>
